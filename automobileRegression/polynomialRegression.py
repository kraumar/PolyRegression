...
plt.xticks([])
plt.show()
polynomial_kcrossVal(df_copy, ['symboling'], ['price'], 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal(df2, ['normalized_losses'], ['price'], 4)
print("")
del df2
...
plt.xticks([])
plt.show()
polynomial_kcrossVal_dummy(df_copy, ['make'], ['price'], 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal(df_copy, ['horsepower'], ['price'], 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal_cat(df_copy, ['aspiration'], ['price'], {'aspiration': {'std': 0, 'turbo': 1}}, 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal_cat(df_copy, ['num_of_doors'], ['price'], {'num_of_doors': {'two': 0, 'four': 1}}, 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal_cat(df_copy, ['drive_wheels'], ['price'], {'drive_wheels': {'fwd': 0, 'rwd': 1, '4wd': 2}}, 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal_cat(df_copy, ['engine_location'], ['price'], {'engine_location': {'front': 0, 'rear': 1}}, 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal(df_copy, ['wheel_base'], ['price'], 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal(df_copy, ['length'], ['price'], 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal(df_copy, ['width'], ['price'], 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal(df_copy, ['height'], ['price'], 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal(df_copy, ['curb_weight'], ['price'], 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal_dummy(df_copy, ['engine_type'], ['price'], 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal(df_copy, ['engine_size'], ['price'], 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal_dummy(df_copy, ['fuel_system'], ['price'], 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal(df_copy, ['bore'], ['price'], 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal(df_copy, ['stroke'], ['price'], 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal(df_copy, ['compression_ratio'], ['price'], 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal(df_copy, ['peak_rpm'], ['price'], 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal(df_copy, ['city_mpg'], ['price'], 4)
print("")
...
plt.xticks([])
plt.show()
polynomial_kcrossVal(df_copy, ['highway_mpg'], ['price'], 4)
print("")